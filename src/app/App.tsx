...
export default function App() {
  ...
  return (
    <div style={{ ...bodySx, background: DARK, color: PEACH, overflowX: "hidden" }}>
      ...
      {/* HERO                                                                */}
      {/* ════════════════════════════════════════════════════════════════════ */}
      <section className="relative min-h-screen flex items-end" style={{ paddingTop: "96px" }}>
        {/* Ambient glow */}
        <div
        ...
        <div className="relative z-10 w-full grid md:grid-cols-[1fr_42%] items-end min-h-[calc(100vh-96px)]">
