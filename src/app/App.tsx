...
export default function App() {
  ...
  return (
    <div style={{ ...bodySx, background: DARK, color: PEACH, overflowX: "hidden" }}>
      ...
      {/* HERO                                                                */}
      {/* ════════════════════════════════════════════════════════════════════ */}
      <section className="relative min-h-screen flex items-end" style={{ paddingTop: "8rem" }}>
        {/* Ambient glow */}
        <div
        ...
        <div className="relative z-10 w-full grid md:grid-cols-[1fr_42%] items-end min-h-[calc(100vh-8rem)]">
            ...
            {(Object.keys(CAT_META) as Exclude<Cat, "all">[]).map(key => {
              ...
              return (
                <button
                  ...
                  className="text-left cursor-pointer h-full flex flex-col items-stretch"
                  style={{ background: "none", border: "none", padding: 0 }}
                  onMouseEnter={() => setHovCat(key)}
                  onMouseLeave={() => setHovCat(null)}
                >
                  <div className="relative aspect-[3/4] w-full shrink-0 overflow-hidden mb-3">
                    <img
                      src={meta.img}
                      alt={meta.label}
