...
const CAT_META: Record<Exclude<Cat, "all">, { label: string; desc: string; count: number; img: string }> = {
  cabin: {
    ...
    count: 318,
    img: "https://images.unsplash.com/photo-1618773928121-c32242e63f39?w=700&h=900&fit=crop&auto=format",
  },
  noho: {
    label: "After NoHo",
    desc: "Coming back after a night out.",
    count: 241,
    img: "https://images.unsplash.com/photo-1712961751512-412da27901e4?w=700&h=900&fit=crop&auto=format",
  },
  morning: {
    label: "Morning After Mode",
    desc: "Coffee, messy hair, zero regrets.",
    count: 197,
    img: "https://images.unsplash.com/photo-1677161190077-50bf52cc7919?w=700&h=900&fit=crop&auto=format",
  },
  solo: {
    label: "Solo Sleep Club",
    desc: "The whole bed, all yours.",
    count: 284,
    img: "https://images.unsplash.com/photo-1778658557549-3e731fff5d7c?w=700&h=900&fit=crop&auto=format",
  },
  redeye: {
    label: "Red Eye Arrivals",
    desc: "Landed. Checked in. Out cold.",
    count: 156,
    img: "https://images.unsplash.com/photo-1767556879107-c98cebc84a10?w=700&h=900&fit=crop&auto=format",
  },
};
...
const PHOTOS: Photo[] = [
  {
    ...
    img: "https://images.unsplash.com/photo-1559414059-34fe0a59e57a?w=600&h=800&fit=crop&auto=format",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1712961751512-412da27901e4?w=600&h=450&fit=crop&auto=format",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1611971263243-4beb5bc92c35?w=600&h=800&fit=crop&auto=format",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1778658557549-3e731fff5d7c?w=600&h=450&fit=crop&auto=format",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1767556879107-c98cebc84a10?w=600&h=900&fit=crop&auto=format",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1647792855184-af42f1720b91?w=600&h=500&fit=crop&auto=format",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1759221793465-4795ba2eaafc?w=600&h=750&fit=crop&auto=format",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1506606401543-2e73709cebb4?w=600&h=400&fit=crop&auto=format",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1629140727571-9b5c6f6267b4?w=600&h=900&fit=crop&auto=format",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1505811210036-052144988918?w=600&h=450&fit=crop&auto=format",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1677161190077-50bf52cc7919?w=600&h=800&fit=crop&auto=format",
    tags: ["#NowNowLightsOut", "#MorningAfterMode"], aspect: "aspect-[3/4]",
  },
  {
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1711059985570-4c32ed12a12c?w=600&h=800&fit=crop&auto=format",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1599394270986-59f54dc05699?w=600&h=900&fit=crop&auto=format",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1586294310477-243d2beb0be1?w=600&h=400&fit=crop&auto=format",
  ...
  return (
    <div style={{ ...bodySx, background: DARK, color: PEACH, overflowX: "hidden" }}>
      ...
      <section className="relative min-h-screen flex items-end" style={{ paddingTop: "80px" }}>
        {/* Background glow */}
        <div className="absolute inset-0 pointer-events-none" style={{ background: `radial-gradient(ellipse 70% 60% at 15% 60%, rgba(104,18,56,0.22) 0%, transparent 65%), radial-gradient(ellipse 50% 40% at 85% 30%, rgba(0,89,81,0.12) 0%, transparent 65%)` }} />
        ...
        <div className="relative z-10 w-full grid md:grid-cols-[1fr_42%] gap-0 items-end min-h-[calc(100vh-80px)]">
          ...
          <div className="relative h-full min-h-[60vw] md:min-h-0 overflow-hidden">
            ...
            <div className="absolute inset-0">
              <img
                src="https://images.unsplash.com/photo-1559414059-34fe0a59e57a?w=800&h=1100&fit=crop&auto=format"
            ...
            <div className="absolute bottom-16 right-6 w-[42%] shadow-2xl z-10 border" style={{ borderColor: `${BLUSH}22` }}>
              <div className="aspect-[3/4] overflow-hidden">
                <img
                  src="https://images.unsplash.com/photo-1767556879107-c98cebc84a10?w=400&h=530&fit=crop&auto=format"
                  alt="Red eye arrival"
                  className="w-full h-full object-cover"
                />
              </div>
      ...
      <section style={{ background: TEAL }} className="py-24 px-6 md:px-12 lg:px-20">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="aspect-[3/4] overflow-hidden">
              <img
                src="https://images.unsplash.com/photo-1559414059-34fe0a59e57a?w=800&h=1050&fit=crop&auto=format"
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-8 pb-8" style={{ borderBottom: `1px solid rgba(247,183,251,0.2)` }}>
              <div className="w-8 h-8 rounded-full overflow-hidden flex-shrink-0">
                <img
                  src="https://images.unsplash.com/photo-1559414059-34fe0a59e57a?w=64&h=64&fit=crop&auto=format"
                  alt="Mara Osei"
                  className="w-full h-full object-cover"
                />
              </div>
